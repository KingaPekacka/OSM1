...
public class DataPanel extends JPanel implements ActionListener
{
	...
	JTextField nameTextField, surnameTextField, peselTextField;
	JRadioButton femaleButton;
	JRadioButton maleButton;
	JComboBox<String> insuranceComboBox;
	...
	public DataPanel()
	{
	   ...
	   // saveandcancelPanel.add(Box.createHorizontalGlue());
		...
		saveandcancelPanel.add(saveButton);
		saveButton.addActionListener(this);
		
		JButton cancelButton = new JButton("Anuluj");
		saveandcancelPanel.add(cancelButton);
	...
	public void actionPerformed(ActionEvent arg0) 
	{
		...
		Object source = arg0.getSource(); //w zmiennej source zawarty byl obiekt ktory jest zrodlem zdarzenia (albo przycisk zapisz albo anuluj)
